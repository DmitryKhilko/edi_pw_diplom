...
class Fake:
    ...
    def date(param_name: str, param_value: any, validation: str):
        ...
        invalid_set = (
            ...
            '12.00.1973', '1973-00-12', '12.03.0000', '0000-03-12', '99.99.9999', '9999-99-99', '12.03.9999',
            '9999-03-12', '12.99.1973', '1973-99-12', '99.03.1973', '1973-03-99', 'dd.03.1973', '1973-03-dd',
            '12.mm.1973', '1973-mm-12', '12.03.yyyy', 'yyyy-03-12' 'dd.mm.yyyy', 'yyyy-mm-dd', '12/03/1973',
            '1973/03/12', '🍏😀.🐱🐹.🐰🐻🍅🍻', '🍏😀🐱🐹-🐰🐻-🍅🍻'
        )
