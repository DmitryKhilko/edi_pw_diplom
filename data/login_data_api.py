...
Тесты классифицируются как smoke. 
Данные предназначены для проверки входа в приложение под всеми ролями с валидными значениями логина и пароля. 
...
"""
Тестовые данные для параметризованных api-тестов. 
Тесты классифицируются как critical_path.  
Данные предназначены для проверки входа в приложение под ролью АИБ с не валидными, пустыми значениями 
логина и (или) пароля. 
Структура кортежа: user (учетные данные пользователя), expected_result (ожидаемый ответ сервера).
"""
